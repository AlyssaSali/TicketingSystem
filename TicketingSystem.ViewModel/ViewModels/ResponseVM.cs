...
namespace TicketingSystem.ViewModel.ViewModel
{
    public class ResponseVM
    {
        ...
        public ResponseVM(string action, bool isSuccess, string entity, string msg = "", string identifier = "", Exception exception = null, IEnumerable<object> errors = null)
        {
            IsSuccess = isSuccess;
            if (isSuccess)
            {
